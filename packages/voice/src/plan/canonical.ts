 ...
 *
 * Канонизация ОДНА на весь пакет — `canonicalJson` из `@vpe/schema` (решение владельца, `V-03`
 * вопрос 5: «двух канонизаций одного объекта быть не должно»). Она сортирует ключи на всех
