...
describe('свои файлы демо (`demo/assets/**`): байты сверены, сирот нет', () => {
  ...
  const EXPECTED_BYTES: Readonly<Record<string, string>> = {
    ...
    // `VID-02a`, 2026-09-11. Синтетика `testsrc2`, 320×180, 48 кадров при 24/1 fps, 21 580 Б,
    // порождена пришпиленным ffmpeg 7.0.2 с флагами воспроизводимости канального энкодера.
    ...
    'video@1/demo/assets/demo-clip-320x180.mp4':
      'efd8a4a179defe28cb3d5d8ac1d492a597ce7f8293cfd8867c990a1aa17bb27b',
  };
