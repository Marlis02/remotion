...
//
// СПИСОК ИСКЛЮЧЕНИЙ ПУСТ, И ЭТО ИЗМЕРЕНО: под тремя корнями выше сегодня нет ни одного
// файла, которому NUL был бы нужен. Если такой появится (бинарная фикстура), он обязан быть
// НАЗВАН здесь — то есть попасть в дифф и в ревью, а не проскочить молча.
