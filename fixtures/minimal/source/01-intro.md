...
[pause: 600ms] The town archive kept a list of those goods. The entries are short, the hand is even, and almost every line ends with the same word.

## scene: turn

[img: ledger] The word is [say: “waiting” | waiting]. Not delay, not idle time, but waiting, as though the cargo had a will of its own.

The warehouse keeper kept count of the days. [beat: count] Each day he drew a short stroke in the corner of the page, and by the end of the month the corner was black.
