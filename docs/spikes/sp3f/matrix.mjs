/**
 * SP-3f: драйвер матрицы. Один прогон — один процесс, таймаут на прогон,
...
const TIMEOUT_MS = Number(process.env.SP3F_TIMEOUT_MS ?? 420000);
const DEADLINE = process.env.SP3F_DEADLINE ? Number(process.env.SP3E_DEADLINE) : null;
